...
var TodoWhere = struct {
	...
	Note:     whereHelpernull_String{field: "\"todo\".\"note\""},
	Finished: whereHelperbool{field: "\"todo\".\"finished\""},
	DueDate:  whereHelpernull_Time{field: "\"todo\".\"due_date\""},
}
...
var (
	todoAllColumns            = []string{"id", "title", "note", "finished", "due_date"}
	todoColumnsWithoutDefault = []string{"title", "finished"}
	todoColumnsWithDefault    = []string{"id", "note", "due_date"}
